...
'''
NÃO ESQUEÇA DE CRIAR AS TABELAS E COLOCAR SUAS CREDENCIAIS DO BANCO PROF!!
...
Só deixando claro que essa foi a única parte do challenge que fiz com carinho então olha com carinho tbm, abraços!
'''
...
# Tá bom eu sei que é errado isso, mas... é o email do projeto, jajá eu apago ele.
...
''')
    print('''
                1) Adicionar Mecânico
                2) Listar Mecânicos
                3) Remover Mecânico
                4) Editar Mecânico
                5) Exportar lista de mecânicos para um arquivo JSON
...
''')
    print('''
                ...
                3) Remover Serviço
                4) Editar Serviço
                5) Exportar lista de serviços para um arquivo JSON
                6) Voltar para o menu principal
                7) Sair do programa
''')
    print('''
